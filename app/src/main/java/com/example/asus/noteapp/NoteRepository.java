...
import com.example.asus.noteapp.Room.NoteDao;
import com.example.asus.noteapp.Room.NoteDatabase;
...
public class NoteRepository {
    ...
    //Have to be handled in background thread manually bc room doesn't allow db operations in main thread
